...
function airConditioning()
{
    ...
    let aircondStatus = confirm("Is the airconditioner Ok?", true)
    if (currTemp > desiredTemp && aircondStatus) console.log("Turn on the A/C Please")
    else if (testScore > desiredTemp && !aircondStatus) console.log("Fix the A/C now!  It's hot!")
    else if (testScore < desiredTemp && !aircondStatus) console.log("Fix the A/C whenever you have the chance...It's cool...")
...
function youAndYourGoverment()
{
    console.log("You and Your Government")
    ...
    console.log("End of You and Your Government")
...
//(using the rules described [here](http://blog.writeathome.com/index.php/2011/12/
//how-to-make-nouns-plural/))

function thePluralizer()
{
